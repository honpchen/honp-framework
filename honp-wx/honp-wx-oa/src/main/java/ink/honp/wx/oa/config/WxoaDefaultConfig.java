 ...
 */
@Data
public class WxoaDefaultConfig implements WxoaConfig {

    private static final Integer DEFAULT_TIMEOUT = 2 * 60;
    private static final String DEFAULT_CLIENT_TAG = "WX OA";
    ...
    public WxoaDefaultConfig(String appid, String secret) {
        this(appid, secret, null, null);
    }

    public WxoaDefaultConfig(String appid, String secret, HttpLogLevel level) {
        this(appid, secret, null, null, DEFAULT_TIMEOUT, level);
    }

    public WxoaDefaultConfig(String appid, String secret, String token, String encodingAesKey) {
